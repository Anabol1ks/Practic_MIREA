...
* location (VARCHAR, NN, номер или местоположение в клубе)
...
*Сотрудник может обслуживать разные ПК, но не является частью первичного ключа таблицы PC_Service.

### Full_Name - Staff(n:1) — идентифицирующая связь.

### Full_Name - Client(n:1) — идентифицирующая связь.